    ...
    if (currentListingId && selectedCategory) {
        ...
        try {
          ...
          setPhotos(currentPhotos => {
            ...
            if (targetIndex !== -1) {
              ...
              // Update parent component with the latest photos after each successful upload
              updateFormData({ photos: updatedPhotos, photosToDelete });
            }
      ...
      try {
        ...
        setPhotos(currentPhotos => {
          ...
          // Make sure we pass the updated photos with status and ID to the parent component
